...
namespace Roles.Controllers
{
    ...
    public class TasksController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                Tasks = tasks.Select(task => new TaskReadVM
                {
                    Task = task,
        ...
        public async Task<IActionResult> Create(int projectId, [Bind("Id,Summary,Description,Status,Assignee,StoryPoints")] Models.Task task)
        {
        ...
        public async Task<IActionResult> Edit(int? id, string returnUrl)
        {
            ...
            var task1 = await _context.Task.FindAsync(id);
            if (task1 == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, string returnUrl, [Bind("Id,Summary,Description,Status,Assignee,StoryPoints")] Models.Task task)
        {
            if (id != task.Id)
            {
                return NotFound();
